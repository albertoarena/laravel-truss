...
The **export** button (the download icon in the top-right) saves the whole current diagram, whatever the filter and focus are showing, as an image:
...
Both are rendered entirely in your browser, embed the diagram font so the text is correct anywhere, and match your current light or dark theme. As always, structure only.
