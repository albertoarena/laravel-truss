...
- **Deep-linkable focus/filter** — reflect the focused table (and filter) in the query string (e.g. `/truss?focus=projects`) so a specific view can be bookmarked, shared, and reopened directly.
